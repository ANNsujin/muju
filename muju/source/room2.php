<? include("top.html") ?>
	<div class="container">
		<div class="menu_nanum">
			<img src="../image/menu2_2.png" arc="../image/menu2_2.png">
			<span> 방 둘러보기 >> 아침이슬</span>
		</div>
		<hr class="menu_line">
		<div class="contents">
			<!-- 도면 -->
		...
		<div class="row">
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				...
				<tbody>
					<tr>
						<th class="r_title_down r_title_up r_title_dark" rowspan="2" style="font-size: 35px; font-family: 'Nanum Pen Script';"> 아침이슬 </th>
						<th class="r_title_up r_title_dark" colspan="2"> 인원 </th>
						<th class="r_title_up r_title_dark" colspan="6"> 요금 </th>
					</tr>
					<tr>
				...
				<div class="col-xs-12 mob">
					...
					<tbody>
						<tr>
							<th class="r_title_down r_title_up r_title_dark" colspan="4" rowspan="2" style="font-size: 35px; font-family: 'Nanum Pen Script';"> 아침이슬 </th>
							<th class="r_title_up r_title_dark" colspan="2"> 인원 </th>
						</tr>
						<tr>
							<td class="r_title_down r_title_light" style="font-weight:bold;"> 기준인원 </td>
				...
				<div class="col-lg-6 col-md-6 col-sm-6 room_footer desktop" >
					<p><b> * 공지사항 :</b> 침대, 냉장고, 식탁, 의자, TV, 드라이기 제공
						...
						<br><b> *&nbsp&nbsp&nbsp&nbsp욕실&nbsp&nbsp&nbsp&nbsp:</b> 샴푸, 린스, 바다샴푸, 개별 수건 구비 </p>
				</div>
				<div class="col-lg-6 col-md-6 col-sm-6 room_footer desktop">
					<p><b> * 유의사항 :</b> 객실 내부에서 지정된 물품 외의 취사 금지
						...
						<br>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp객실 내 바베큐 불가 → 외부 테라스 이용 </p>
				...
				<div class="col-xs-12 room_footer mob" >
					<p><b> * 공지사항 :</b> 침대, 냉장고, 식탁, 의자, TV, 드라이기 제공
						...
						<br>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp객실 내 바베큐 불가 → 외부 테라스 이용 </p>
					<p style="font-weight:bold"> ※ 1인 추가시, 만원 추가 </p>
				</div>
			</div>
		</div>
