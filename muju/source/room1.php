	...
	<div class="container">
		...
		<div class="row">
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				...
				<tbody>
					<tr>
						<th class="r_title_down r_title_up r_title_dark" rowspan="2" style="font-size: 35px; font-family: 'Nanum Pen Script';"> 하늘정원 </th>
				...
				<div class="col-xs-12 mob">
					...
					<tbody>
						<tr>
							<th class="r_title_down r_title_up r_title_dark" colspan="4" rowspan="2" style="font-size: 35px; font-family: 'Nanum Pen Script';"> 하늘정원 </th>
							<th class="r_title_up r_title_dark" colspan="2"> 인원 </th>
						</tr>
						<tr>
							<td class="r_title_down r_title_light" style="font-weight:bold;"> 기준인원 </td>
