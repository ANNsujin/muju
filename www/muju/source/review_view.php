...
?>
	<div class="container">
		...
		<div class="contents">
			<div class="panel panel-default">
				<div class="panel-heading" style="text-align:left;">
					...
					<span style="font-size:10px; color:#888; padding-top:10px;">
						...
						<span style="padding-left:10px;"> 조회&nbsp <?= $row['View'] ?> </span><br>
						<span style="font-weight:bold;"> 작성자 :&nbsp <?= $row['Writer'] ?> </span>
					</span>
				</div>
				...
				<div class="panel-footer" style="text-align:left;">
					...
					<?php
						...
						<a href="/muju/source/download.php?ID=<?= $ID ?>"><?=$row['File']?></a>
						<?php } ?>
					</span>
				</div>
			</div>
			<div class="board_button">
			<button onclick="location.href='/muju/source/review.php';" class="btn btn-default btn-sm">목록</button>
			<?php
			...
			{	?>
				<button onclick="location.href='/muju/source/review_view.php?ID=<?= $prev_id['ID'] ?>'" class="btn btn-default btn-sm">이전</button>
			<?php }
			else
			{	?>
			...
			if ($next_id['ID'])
			{	?>
				<button onclick="location.href='/muju/source/review_view.php?ID=<?= $next_id['ID'] ?>'" class="btn btn-default btn-sm">다음</button>
			<?php }
			else
			{	?>
			...
			<div class="modal fade" id="modModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel01">
			  <div class="modal-dialog modal-sm" role="document">
				<div class="modal-content">
				  ...
				  <form action="/muju/source/review_check_auth.php" method="post">
