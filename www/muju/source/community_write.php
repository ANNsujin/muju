...
<script type="text/javascript" src="/muju/se/js/HuskyEZCreator.js" charset="utf-8"></script>
	<div class="container">
		<div class="contents">
			<form enctype="multipart/form-data" class="form-horizontal" id="frm" action="/muju/source/community_do.php" method="post">
				<fieldset>
				...
				<div class="board_button">
					<label style="visibility:hidden;" class="col-lg-2 col-md-2 col-sm-2 col-xs-2 control-label">버튼</label>
						&nbsp
						<button type="button" onclick="alert ('목록으로 돌아갑니다.'); location.href='/muju/source/community.php';" class="btn btn-default btn-sm">취소</button>
