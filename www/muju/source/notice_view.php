...
?>
	<div class="container">
		...
		<div class="contents">
			...
			<button onclick="location.href='/muju/source/notice.php';" class="btn btn-default btn-sm">목록</button>
			<?php
			...
			{	?>
				<button onclick="location.href='/muju/source/notice_view.php?ID=<?= $prev_id['ID'] ?>'" class="btn btn-default btn-sm">이전</button>
			<?php }
			else
			{	?>
			...
			if ($next_id['ID'])
			{	?>
				<button onclick="location.href='/muju/source/notice_view.php?ID=<?= $next_id['ID'] ?>'" class="btn btn-default btn-sm">다음</button>
			<?php }
			else
			{	?>
