...
?>
	<div class="container">
		...
		<div class="contents">
			...
			<button onclick="location.href='/muju/source/community.php';" class="btn btn-default btn-sm">목록</button>
			<?php
			...
			{	?>
				<button onclick="location.href='/muju/source/community_view.php?ID=<?= $prev_id['ID'] ?>'" class="btn btn-default btn-sm">이전</button>
			<?php }
			else
			{	?>
			...
			if ($next_id['ID'])
			{	?>
				<button onclick="location.href='/muju/source/community_view.php?ID=<?= $next_id['ID'] ?>'" class="btn btn-default btn-sm">다음</button>
			<?php }
			else
			{	?>
			...
			<div class="modal fade" id="modModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel01">
			  <div class="modal-dialog modal-sm" role="document">
				<div class="modal-content">
				  ...
				  <form action="/muju/source/community_check_auth.php" method="post">
