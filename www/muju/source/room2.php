<?php include $_SERVER['DOCUMENT_ROOT']."/muju/source/top.html";?>
	<div class="container">
		<div class="menu_nanum">
			<img src="/muju/image/menu2_2.png" arc="/muju/image/menu2_2.png">
			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="carousel slide" id="myCarousel">
                    ...
                    <div class="carousel-inner">
                        ...
                        <img src="/muju/image/sample.png" arc="/muju/image/sample.png"></div>
		...
		<div class="row">
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				...
				<tbody>
					<tr>
						<th class="r_title_down r_title_dark" rowspan="2" style="font-size: 35px; font-family: 'Nanum Pen Script';"> 아침이슬 </th>
					...
					<tr>
						<td class="r_title_down" colspan="3"> 외부 데크 포함 20평 </td> <!-- 확인 필요 -->
				...
				<div class="col-xs-12 mob">
					...
					<tbody>
						<tr>
							<th class="r_title_down r_title_dark" colspan="4" rowspan="2" style="font-size: 35px; font-family: 'Nanum Pen Script';"> 아침이슬 </th>
							<th class="r_title_dark" colspan="2"> 인원 </th>
						</tr>
						<tr>
							<td class="r_title_down r_title_light" style="font-weight:bold;"> 기준인원 </td>
						...
						<tr>
							<td colspan="4"> 외부 데크 포함 20평 </td> <!-- 확인 필요 -->
						</tr>
						<tr>
							<th class="r_title_dark" colspan="6"> 요금 </th>
						</tr>
