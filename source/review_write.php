		...
		<div class="contents">
			<form enctype="multipart/form-data" class="form-horizontal" action="review_do.php" method="post">
				...
				<div class="form-group">
					<label for="inputName" class="col-lg-2 col-md-2 col-sm-2 col-xs-2 control-label">Writer</label>
					<div class="col-lg-3 col-md-4 col-sm-4 col-xs-10">
						<input type="text" class="form-control" id="inputName" name="Writer">
					</div>
				...
				<div class="board_button">
					<label style="visibility:hidden;" class="col-lg-2 col-md-2 col-sm-2 col-xs-2 control-label">버튼</label>
						&nbsp
						<button type="button" onclick="alert ('목록으로 돌아갑니다.'); location.href='review.php';" class="btn btn-default btn-sm">취소</button>
